...
var UserPage = /** @class */ (function () {
    ...
    UserPage.prototype.updateProgress = function (data) {
        ...
        if (this.isLoading == true) {
            ...
            if (this.userProvider.user.is_spv == "0") {
                ...
                this.helperMethod.loadingService("Updating your sprint..");
                this.userProvider.updateSprintProgressSPV(request).then(function (response) {
                    _this.helperMethod.loading.dismiss();
                    console.log(response);
                    var responseData = JSON.parse(response.data);
                    var responseStatus = response.status;
    ...
    UserPage.prototype.getSprint = function () {
        ...
        this.userProvider.getClaimedSprintByUser(userLogin)
            ...
            console.log(responseData.status);
            if (responseData.status.code == "0") {
                _this.userProvider.claimedSprintDetailList = responseData.sprintDetail;
                _this.getUnclaimedSprint();
            }
            else {
                _this.errorHandler.catchResponseErrorHandler(responseData);
            }
    ...
    UserPage.prototype.getUnclaimedSprint = function () {
        ...
        this.userProvider.getUnclaimedSprint(userLogin)
            ...
            console.log(responseData.status);
            if (responseData.status.code == "0") {
                _this.userProvider.unclaimedSprintDetailList = responseData.sprintDetail;
            }
            else {
                _this.errorHandler.catchResponseErrorHandler(responseData);
            }
    ...
    UserPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_6_ionic_angular__["k" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_7__providers_users_usersProvider__["a" /* UsersProvider */],
            __WEBPACK_IMPORTED_MODULE_4__providers_helper_method_helper_method__["a" /* HelperMethodProvider */],
            __WEBPACK_IMPORTED_MODULE_3__providers_error_handler_error_handler__["a" /* ErrorHandlerProvider */],
            __WEBPACK_IMPORTED_MODULE_2__providers_storage_storageProvider__["a" /* StorageProvider */],
            __WEBPACK_IMPORTED_MODULE_1_ngx_progressbar__["a" /* NgProgress */],
            __WEBPACK_IMPORTED_MODULE_6_ionic_angular__["c" /* Events */], __WEBPACK_IMPORTED_MODULE_6_ionic_angular__["a" /* AlertController */]])
    ], UserPage);
    return UserPage;
}());
...
var UsersProvider = /** @class */ (function () {
    ...
    UsersProvider.prototype.updateSprintProgressSPV = function (userLogin) {
        var headers = this.oauthProvider.getHeader(this.oauthProvider.userOAuth.access_token);
        console.log(headers);
        this.httpNative.setDataSerializer('json');
        ...
        this.httpNative.setRequestTimeout(60);
        return this.httpNative
            .post(this.globalVal.ipUrl + this.globalVal.baseUrl + this.globalVal.updateSprintProgressSPV, userLogin, headers);
    };
...
var GlobalVariableProvider = /** @class */ (function () {
    function GlobalVariableProvider() {
        ...
        //local
        this.ipUrl = 'http://172.18.0.67:8080/';
        ...
        this.getClaimedSprintByUser = 'claim/getClaimedSprintByUser';
        this.getUnclaimedSprint = 'claim/getUnclaimedSprint';
        this.updateSprintProgress = 'claim/updateSprintProgress';
        this.updateSprintProgressSPV = 'claim/updateSprintProgressSPV';
        this.claimSprint = 'claim/claimSprint';
    }
